 ...
 * @date 2018-10-14, 14:27:39
 * 
 * @method static static findFirstByBikeId($bike_id)
 * @method static static[] findByBikeId($bike_id)
 * @method static int countByBikeId($bike_id)
 ...
 */
class BikeRefreshes extends BaseModel
{
    ...
    /**
     * Method to set the value of field bike_id
     *
     * @param integer $bike_id
     * @return static
     */
    public function setBikeId($bike_id)
    {
    ...
    /**
     * Returns the value of field bike_id
     *
     * @return integer
     */
