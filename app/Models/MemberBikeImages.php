...
class MemberBikeImages extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->setSchema("ddb");
        $this->setSource("member_bike_images");
    }
     ...
     * @return MemberBikeImages[]|MemberBikeImages|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return MemberBikeImages|\Phalcon\Mvc\Model\ResultInterface
     */
