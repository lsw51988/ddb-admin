 ...
 * 
 * @method static static findFirstByMessageId($message_id)
 * @method static static[] findByMessageId($message_id)
 * @method static int countByMessageId($message_id)
 ...
 */
class MessageReads extends BaseModel
{
