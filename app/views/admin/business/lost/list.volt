                ...
                <div class="layui-col-md4">
                    ...
                    <div class="layui-input-block">
                        <select name="status">
                            ...
                            <option value="0" {% if search['status']==0 %}selected{% endif %}>刚创建</option>
                            <option value="1" {% if search['status']==1 %}selected{% endif %}>审核通过</option>
                            <option value="2" {% if search['status']==2 %}selected{% endif %}>审核失败</option>
                            <option value="2" {% if search['status']==3 %}selected{% endif %}>成功找到</option>
                            <option value="2" {% if search['status']==4 %}selected{% endif %}>未找到</option>
                        </select>
                    </div>
                </div>
            </div>
    ...
    <table class="layui-table">
        ...
        {% for bike in data %}
            <tr>
                ...
                <td>{{ bike['memo'] }}</td>
                <td>{{ bike['fail_time'] }}</td>
                <td>{{ bike['contact_time'] }}</td>
                <td>{{ bike['reason'] }}</td>
        ...
        layui.use(['laypage', 'jquery', 'form'], function () {
            ...
            laypage.render({
                ...
                , jump: function (obj, first) {
                    if (!first) {
                        window.location.href = "/admin/business/lost/list?page=" + obj.curr
                    }
                }
            });
            ...
            $("#reset").click(function () {
                window.location.href = "/admin/business/lost/list";
            });
