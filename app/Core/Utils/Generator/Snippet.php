...
EOD;
    ...
    public function getMagicMethod($setterName, $fieldName)
    {
        $templateMagicMethod = <<<EOD
 * @method static static findFirstBy%s(\$%s)
 * @method static static[] findBy%s(\$%s)
 * @method static int countBy%s(\$%s)
EOD;
        return PHP_EOL.sprintf($templateMagicMethod, $setterName, $fieldName, $setterName, $fieldName, $setterName, $fieldName);
    }
...
EOD;
    ...
    public function getClassDoc($className, $namespace = '', $magicMethods = '')
    {
        if (!empty($namespace)) {
 ...
 */
EOD;
        return sprintf($classDoc, $className, $namespace, date('Y-m-d, H:i:s'), $magicMethods).PHP_EOL;
    }
