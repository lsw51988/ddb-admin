...
class CreateMemberSignsTables extends AbstractMigration
{
    ...
    public function change()
    {
        $this->table("member_signs")
            ...
            ->addColumn("week_count", "integer", ["limit" => MysqlAdapter::INT_TINY, "default" => 1, "comment" => "本周签到次数"])
            ->addColumn("month_count", "integer", ["limit" => MysqlAdapter::INT_TINY, "default" => 1, "comment" => "本月签到次数"])
