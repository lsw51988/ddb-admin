...
class CreateSecondBikesTable extends AbstractMigration
{
    ...
    public function change()
    {
        $this->table("second_bikes")
            ...
            ->addColumn("buy_time", "date", ["null" => false,  "comment" => "购买时间"])
            ->addColumn("voltage", "integer", ["limit" => MysqlAdapter::INT_TINY, "null" => false, "comment" => "电压"])
            ->addColumn("brand_id", "integer", ["limit" => MysqlAdapter::INT_TINY, "null" => false, "comment" => "品牌对应brand表"])
            ...
            ->addColumn("card_num", "string", ['limit' => 20,"null" => false, "comment" => "车牌号"])
            ->addColumn("extended", "integer", ["limit" => MysqlAdapter::INT_TINY,"default" => 0, "comment" => "是否延期过一次"])
            ->addColumn("status", "integer", ["limit" => MysqlAdapter::INT_TINY,"default" => 0, "comment" => "状态 1提交 2审核通过 3审核拒绝 4成功交易 5过期4天 6过期7天 7状态异常"])
